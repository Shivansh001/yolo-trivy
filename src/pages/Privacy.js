...
const Privacy = () => {
  return (
    ...
    <div className='privacy'>
      ...
      <p>Members are asked to provide certain
      information when they apply for membership such as name, address, telephone
      number, billing information (such as a credit card number).  The
      ...
      or telephone number) about your visits to this and other websites in
      order to provide advertisements on this site and other sites about goods
      and services that may be of interest to you.  <br /></p>

      <h5>Voluntary Surveys</h5>
      <p>We may periodically conduct both business
      and individual surveys.  We encourage members to participate in
      these voluntary surveys because they provide us with important information
      that helps us to improve the types of services we offer and how we provide
      them to you.  Your personal information and responses will remain
      confidential, even if the survey is conducted by a third-party. <br />
      </p>
      <p>We take the information we receive
      from individuals responding to our surveys and combine (or aggregate)
      it with the responses of other members to create broader, generic responses
      to the survey questions (such as gender, age, residence, hobbies, education,
      employment, industry sector, or other demographic information).
      We then use the aggregated information to improve the quality of our
      services to you, and to develop new services and products.  This aggregated,
      non-personally identifying information may be shared with third-party
      partners. <br /></p>
      ...
      and expressly disclaim responsibility for information collected through
      them. <br /></p>

      <h5>Public Forums</h5>
      <p>Any information that you disclose in
      public areas of our websites or the Internet may become public information.
      ...
      illegally obtaining this information.  We will never sell your information
